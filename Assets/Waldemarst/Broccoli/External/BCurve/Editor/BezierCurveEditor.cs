    ...
    public class BezierCurveEditor { 
        ...
        */
            ...
            switch (ctrlToDraw) {
                case ControlType.FreeMove:
                    ...
                    if (node.isSelected) {
                        ...
                        if (rayDragEnabled) {
                            var fmh_1193_78_638366189004587260 = Quaternion.identity; newPosition = Handles.FreeMoveHandle (s_tmpNode, handleSize * nodeSize, Vector3.zero, selectedNodeDrawFunction);
                        } else {
        ...
        void DrawBezierNodeHandle1 (BezierNode node, int index, Vector3 sceneOffset, float scale, bool isLastNode) {
            ...
            var fmh_1352_17_638366189004610300 = Quaternion.identity; Vector3 newGlobal1 = Handles.FreeMoveHandle (
                s_tmpHandle1, 
        ...
        void DrawBezierNodeHandle2 (BezierNode node, int index, Vector3 sceneOffset, float scale, bool isLastNode) {
            ...
            var fmh_1393_17_638366189004612650 = Quaternion.identity; Vector3 newGlobal2 = Handles.FreeMoveHandle(
                s_tmpHandle2, 
