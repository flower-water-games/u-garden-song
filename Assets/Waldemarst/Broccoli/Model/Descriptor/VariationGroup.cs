...
namespace Broccoli.Pipe {
    ...
    public class VariationGroup {
        ...
        public Vector3 orientationPlaneNormal = Vector3.right;
        public Vector2 tiltAtCenter = new Vector2 (0, 0);
        public Vector2 tiltAtBorder = new Vector2 (0, 0);
        public Vector2 sideTiltAtCenter = new Vector2 (0, 0);
        public Vector2 sideTiltAtBorder = new Vector2 (0, 0);
        ...
        public VariationGroup Clone () {
            ...
            clone.orientationPlaneNormal = orientationPlaneNormal;
            if (clone.orientationPlaneNormal == Vector3.zero) {
                clone.orientationPlaneNormal = Vector3.right;
            }
            clone.tiltAtCenter = tiltAtCenter;
            clone.tiltAtBorder = tiltAtBorder;
            clone.sideTiltAtCenter = sideTiltAtCenter;
            clone.sideTiltAtBorder = sideTiltAtBorder;
        ...
        public string GetDebugInfo () {
            ...
            if (orientation == OrientationMode.Plane) {
                info += string.Format ("  Orientation Plane Normal: {0}, {1}, {2}\n", orientationPlaneNormal.x, orientationPlaneNormal.y, orientationPlaneNormal.z);
            }
